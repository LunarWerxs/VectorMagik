        ...
        match arg.as_str() {
            ...
            "--look" => {
                options.look = args
                    ...
                    .ok_or("--look takes studio or glass")?;
            }
            "--theme" => {
